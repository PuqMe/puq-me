    ...
    <>
      ...
      <div style={{
        ...
        <div style={{ position: "relative", height: "56vh", flexShrink: 0, overflow: "hidden" }}>
          ...
          {!ready && (
            <div style={{ position: "absolute", inset: 0, zIndex: 10, display: "flex", alignItems: "center", justifyContent: "center", background: "#08070f" }}>
              <div style={{ width: 28, height: 28, borderRadius: "50%", border: "2px solid #a855f7", borderTopColor: "transparent", animation: "rm-spin .8s linear infinite" }} />
            </div>
          )}
          ...
          <div style={{
            ...
            {/* Logo + brand name — fills remaining space */}
        ...
        <nav style={{
          ...
          {/* Nearby — active */}
          <Link href="/nearby" style={{ display: "flex", alignItems: "center", justifyContent: "center", width: 46, height: 30, color: "#a855f7", textDecoration: "none" }}>
